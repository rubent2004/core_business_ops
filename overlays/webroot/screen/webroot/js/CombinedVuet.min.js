...
moqui.urlExtensions={js:"js",vue:"vue",vuet:"vuet"};window.define||(window.define=function(a,b,c){moqui.isString(a)||(c=b,b=a);moqui.isArray(b)||(c=b);return moqui.isFunction(c)?c():c});Vue.filter("decodeHtml",moqui.htmlDecode);Vue.filter("format",moqui.format);
window.cfMenuGroupMap=window.cfMenuGroupMap||{Catalog:"business",Customer:"business",Party:"business",Supplier:"business",Asset:"business",HumanRes:"business",Accounting:"business",ProductStore:"business",Project:"business",Task:"business",Request:"business",Survey:"business",Wiki:"business",QuickSearch:"business",QuickViewReport:"business",SimpleReport:"business",Manufacturing:"ops",Facility:"ops",Order:"ops",Shipment:"ops",Shipping:"ops",Return:"ops",SvLocalization:"fiscal",dashboard:"home"};
window.cfGroupOrder=window.cfGroupOrder||["home","business","ops","fiscal","other"];window.cfGroupLabels=window.cfGroupLabels||{home:"INICIO",business:"CORE BUSINESS",ops:"CORE OPS",fiscal:"FISCAL",other:"OTROS"};moqui.notifyOpts={delay:1500,timer:500,offset:{x:20,y:60},placement:{from:"top",align:"right"},z_index:1100,type:"success",animate:{enter:"animated fadeInDown",exit:""}};
...
this.navMenuList.length-1;a=this.navMenuList[a];if(a.extraPathList&&a.extraPathList.length){var b=a.path+"/"+a.extraPathList.join("/"),c=a.pathWithParams.indexOf("?");0<c&&(b+=a.pathWithParams.slice(c));return b}return a.pathWithParams||a.path},getLinkPath:function(a){this.appRootPath&&this.appRootPath.length&&0!==a.indexOf(this.appRootPath)&&(a=this.appRootPath+a);a=a.split("/");var b=this.appRootPath.split("/").length;a[b]=this.linkBasePath.split("/").slice(-1);return a=a.join("/")},cfGroupedSubscreens:function(a){var b=
window.cfMenuGroupMap||{},c=window.cfGroupOrder||["business","ops","fiscal","other"],d=window.cfGroupLabels||{},e={};c.forEach(function(f){e[f]=[]});(a||[]).forEach(function(f){var g=b[f.name||f.title||""]||"other";e[g]||(e[g]=[]);e[g].push(f)});return c.map(function(f){return{id:f,label:d[f]||f.toUpperCase(),items:e[f]||[]}})}},watch:{navMenuList:function(a){if(0<a.length){var b=a[a.length-1];a=1<a.length?a[a.length-2]:null;b.extraPathList&&(this.extraPathList=b.extraPathList);var c=this.basePathSize,
d=b.path.split("/").slice(c+1);console.info("nav updated fullPath "+JSON.stringify(d)+" currentPathList "+JSON.stringify(this.currentPathList)+" cur.path "+b.path+" basePathSize "+c);this.currentPathList=d;this.reloadSubscreens();a=(a?a.title+" - ":"")+b.title;c=b.pathWithParams;var e=c.indexOf("?");if(0<e){d=["pageIndex","orderBySelect","orderByField","moquiSessionToken"];var f=c.substring(e+1).split("\x26");c=c.substring(0,e);e=0;for(var g="",k=0;k<f.length;k++){var h=f[k];c=-1===c.indexOf("?")?
c+"?":c+"\x26";c+=h;if(!(3<e)){var l=h.indexOf("\x3d");if(0<l){var m=h.substring(0,l);h=h.substring(l+1);0<m.indexOf("_op")||0<m.indexOf("_not")||0<m.indexOf("_ic")||0<=d.indexOf(m)||m===h||(0<g.length&&(g+=", "),g+=decodeURIComponent(h),e++)}}}0<g.length&&(70<g.length&&(g=g.substring(0,70)+"..."),a=a+" ("+g+")")}d=this.navHistoryList;for(f=0;f<d.length;)d[f].pathWithParams===c?d.splice(f,1):f++;for(d.unshift({title:a,pathWithParams:c,image:b.image,imageType:b.imageType});25<d.length;)d.pop();document.title=
a}},currentPathList:function(a){(a=a[a.length-1])&&$(this.$el).removeClass().addClass(a)}},computed:{currentPath:{get:function(){var a=this.currentPathList,b=this.extraPathList;return this.basePath+(a&&0<a.length?"/"+a.join("/"):"")+(b&&0<b.length?"/"+b.join("/"):"")},set:function(a){a&&0!==a.length?("/"===a.slice(a.length-1)&&(a=a.slice(0,a.length-1)),0===a.indexOf(this.linkBasePath)?a=a.slice(this.linkBasePath.length+1):0===a.indexOf(this.basePath)&&(a=a.slice(this.basePath.length+1)),this.currentPathList=
a.split("/")):this.currentPathList=[]}},currentLinkPath:function(){var a=this.currentPathList,b=this.extraPathList;return this.linkBasePath+(a&&0<a.length?"/"+a.join("/"):"")+(b&&0<b.length?"/"+b.join("/"):"")},currentSearch:{get:function(){return moqui.objToSearch(this.currentParameters)},set:function(a){this.currentParameters=moqui.searchToObj(a)}},currentLinkUrl:function(){var a=this.currentSearch;return this.currentLinkPath+(0<a.length?"?"+a:"")},basePathSize:function(){return this.basePath.split("/").length-
...
window.addEventListener("popstate",function(){moqui.webrootVue.setUrl(window.location.pathname+window.location.search,null,null,!1)});
